...
* ExampleDarwinPushPortClientV12 demonstrates how to receive information from the RDG Darwin System (V12 - soon to be discontinued).
...
Before running the code, the lines in the Program.cs file must be updated to contain your personal details.
These can be found in the https://opendata.nationalrail.co.uk/feeds portal.
